...
class Main{
    public static void main(String[] args)
    {
        ...
        Populacao pop = new Populacao(1000, "leonardo vinicius de oliveira toledo"); //Primeiro parâmetro: Quantidade de elementos da população a cada geração
                                                     //Segundo parâmetro: Nome ao qual se deseja que a população evolua
        pop.evolui(1000, "leonardo vinicius de oliveira toledo"); //Evolui a população
